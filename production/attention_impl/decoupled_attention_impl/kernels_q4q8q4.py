...
if not TYPE_CHECKING and TRITON_AVAILABLE:
    try:  # pyright: ignore[reportUnreachable]
        ...
        def kv_decode_update_decoupled_q4q8q4(
            ...
            Why: decode (T==1) needs "online softmax" over potentially long KV prefixes. This kernel fuses:
        ...
        def kv_decode_partition_stats_decoupled_q4q8q4(
            ...
            Why: parallelize decode across the KV sequence length by slicing the prefix into partitions.
