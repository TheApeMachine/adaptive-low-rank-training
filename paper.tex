...
\centering
\small
\caption{FineWeb-Edu Validation Loss (100M tokens, 1024 context, 6000 steps; v29 suite; mean $\pm$ std over three seeds)}
\label{tab:fineweb}
\begin{tabular}{@{}lcccc@{}}
\toprule
\textbf{Model} & \textbf{Attn Config} & \textbf{Params} & \textbf{Val Loss} & \textbf{Val PPL} \\
\midrule
Standard Baseline & $d = 512$ & 139.8M & $6.385 \pm 0.222$ & $602.9 \pm 140.4$ \\
...
\caption{Validation loss curves on FineWeb-Edu (100M tokens; seed 1339).}
