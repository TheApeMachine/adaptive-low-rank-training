#!/usr/bin/env python3
""" 
v30_transformer_decoupled_bottleneck_instrumented.py
...
"Survive scale" upgrades in this v30 variant:
...
class KVSelfOptConfig:
    ...
    quality_compute_kl: bool = False               # compute KL even if no kl tol (for logging)
