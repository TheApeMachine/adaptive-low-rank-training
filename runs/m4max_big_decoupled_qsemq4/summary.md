...
- Created: `2025-12-17T13:53:44+01:00`
- Out dir: `runs/m4max_big_decoupled_qsemq4`
- Device: `mps`
- Command: `v29_transformer_decoupled_bottleneck_instrumented.py --mode train --device mps --data fineweb_100m.npy --data-format npy --out-dir runs/m4max_big_decoupled_qsemq4 --d-model 768 --layers 12 --n-head 12 --d-ff 3072 --attn-mode decoupled --sem-dim 48 --geo-dim 96 --attn-dim 144 --param-dtype bf16 --amp --amp-dtype bf16 --optimizer lion --batch-size 8 --grad-accum 2 --train-seq-len 512 --seq-schedule 256@0,512@500,1024@2000 --live rich --log-every 10 --eval-every 200 --vocab-size 50257`
...
```json
{
  ...
  "opt_fused": false,
  "optimizer": "lion",
  "out_dir": "runs/m4max_big_decoupled_qsemq4",
  "param_dtype": "bf16",
  "print_config": false,
  "prompt_tokens": "0",
  "rope": false,
...
- Last step: `6000`
- Best val loss: `5.814062` (ppl `334.98`)
